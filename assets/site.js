...
(function() {
  ...
  const projectCatalog = {
    agricultura: {
      ...
      description: [
        'Durante los últimos años hemos desarrollado auditorías de biodiversidad y planes de conservación en diversos predios agrícolas ubicados entre las regiones de Coquimbo y Metropolitana, abarcando superficies desde aproximadamente 400 hasta más de 1.500 hectáreas. Estas experiencias han considerado sistemas productivos de paltos, cítricos y carozos, en contextos territoriales y ecológicos muy distintos, lo que nos ha permitido adaptar metodologías y medidas a la realidad específica de cada predio.', 
        'El trabajo realizado ha considerado levantamientos de flora, fauna, insectos benéficos, hábitats naturales y seminaturales, así como evaluaciones de condición biológica del suelo, integrando análisis cartográfico, prospecciones en terreno y recorridos sistemáticos para construir líneas base robustas de biodiversidad intrapredial. Más allá del diagnóstico, cada proceso ha buscado comprender cómo los elementos naturales interactúan con el sistema productivo agrícola y qué oportunidades existen para fortalecer servicios ecosistémicos clave, tales como polinización, control biológico, regulación hídrica y salud del suelo.', 
        'Uno de los principales aprendizajes de estos proyectos ha sido constatar que el conocimiento territorial de administradores, jefes de campo y personal predial constituye un insumo fundamental para el desarrollo de auditorías efectivas. La experiencia ha demostrado que las mejores estrategias de conservación surgen desde un trabajo colaborativo, donde la experiencia práctica del equipo de campo complementa la evaluación técnica y permite diseñar medidas realistas, implementables y coherentes con la operación agrícola. En este sentido, la colaboración con los equipos prediales ha sido consistentemente positiva y un factor clave para el éxito de cada proceso.'
      ],
      deliverables: [
    ...
    paitur: {
      ...
      description: [
        'Durante los últimos años hemos desarrollado e implementado medidas de enriquecimiento de hábitat y planes de manejo de fauna silvestre asociados principalmente a proyectos energéticos, especialmente parques fotovoltaicos emplazados en matrices agrícolas de la zona central de Chile. Estas experiencias han estado orientadas a reducir impactos sobre fauna de baja movilidad, compatibilizando el desarrollo de obras con la conservación de especies silvestres en contextos regulatorios vinculados a Resoluciones de Calificación Ambiental (RCA), medidas de mitigación y Programas de Cumplimiento (PdC).',
        'El trabajo realizado ha considerado caracterización de fauna objetivo, análisis territorial, evaluación de atributos biofísicos del paisaje, microruteo y selección de áreas receptoras con condiciones adecuadas de refugio, termorregulación y disponibilidad de microhábitats. Sobre esta base, hemos diseñado e implementado medidas específicas de enriquecimiento de hábitat, incluyendo pircas, refugios artificiales, estructuras para termorregulación y reutilización estratégica de elementos removidos desde las áreas de intervención, con el objetivo de fortalecer la funcionalidad ecológica de los hábitats receptores.',
        'De manera complementaria, hemos ejecutado planes de perturbación controlada para inducir el desplazamiento progresivo de fauna de baja movilidad previo al inicio de obras, minimizando riesgos de mortalidad y favoreciendo el establecimiento de individuos en zonas previamente acondicionadas. Estos procesos han incorporado protocolos de ejecución en terreno, georreferenciación de medidas, monitoreo posterior y evaluación de efectividad ecológica mediante indicadores verificables, permitiendo dar trazabilidad técnica al desempeño de las medidas implementadas.',
        'Una de las principales lecciones aprendidas ha sido que la coordinación temprana entre especialistas ambientales, equipos constructivos y personal de terreno resulta fundamental para implementar medidas efectivas y operacionalmente viables. La experiencia ha demostrado que las soluciones más exitosas son aquellas que logran equilibrar criterios ecológicos, exigencias regulatorias y restricciones propias de la construcción, permitiendo compatibilizar conservación de biodiversidad y ejecución de proyectos.'
      ],
      partners: [
    ...
    delhum: {
      ...
      description: [
        'Durante los últimos años hemos caracterizado y delimitado 16 humedales urbanos y periurbanos, desarrollando estudios entre las regiones de Coquimbo y Los Lagos, en contextos territoriales altamente diversos. Estas experiencias han considerado humedales emplazados en entornos urbanos, naturales y seminaturales, así como sistemas de distinta escala, desde superficies inferiores a 15 hectáreas hasta humedales de más de 100 hectáreas, lo que nos ha permitido adaptar metodologías y criterios técnicos a las particularidades de cada caso.',
        'El trabajo realizado ha integrado de manera sistemática los tres criterios oficiales de delimitación establecidos en la Ley N° 21.202 y su reglamento —régimen hidrológico, vegetación hidrófita y suelos hídricos— mediante análisis espacial SIG, fotointerpretación histórica con sensores remotos, campañas de terreno, caracterización vegetacional, prospección edáfica y evaluación hidrológica. La experiencia acumulada ha demostrado que cada humedal presenta dinámicas ecológicas e hidrológicas particulares, especialmente en paisajes intervenidos donde la matriz urbana, agrícola o natural condiciona fuertemente la expresión del ecosistema.',
        'Uno de los principales atributos de estos proyectos ha sido su desarrollo desde una lógica multidisciplinaria, integrando especialistas en suelos, flora y vegetación e hidrología para construir diagnósticos robustos y técnicamente defendibles. Esta articulación ha sido clave para abordar casos complejos donde los límites del humedal no son evidentes o donde existen presiones territoriales relevantes, permitiendo generar delimitaciones precisas, sustentadas técnicamente y coherentes con el contexto regulatorio y territorial.',
        'La experiencia ha demostrado que una delimitación rigurosa no solo permite determinar la presencia y extensión de un humedal, sino también comprender su funcionamiento ecológico e hidrológico, aportando insumos relevantes para procesos de planificación territorial, evaluación ambiental, diseño de proyectos y gestión temprana de riesgos regulatorios asociados a humedales urbanos.'
      ],
      partners: [
